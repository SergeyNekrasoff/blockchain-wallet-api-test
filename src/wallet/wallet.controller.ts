...
export class WalletController {
  ...
  @ApiParam({
    name: "address",
    description: "EVM (0x...), Solana (base58), or TON address",
  })
  @ApiResponse({
    status: 200,
    description: "Balance returned (may be from cache)",
  })
  ...
  @ApiResponse({
    status: 200,
    description: "Transaction list returned (may be from cache)",
  })
  ...
  @ApiOperation({
    summary: "Get ERC-20 / SPL token balances (requires MORALIS_API_KEY)",
  })
  @ApiParam({
    name: "address",
  ...
  @ApiOperation({
    summary:
      "Get NFTs owned by a wallet — EVM via Moralis, Solana via Metaplex",
  })
  @ApiParam({
    name: "address",
    description: "EVM (0x...) or Solana (base58) address",
  ...
  @ApiOperation({
    summary: "Get all watched wallets with their current balances",
  })
  ...
  @ApiResponse({
    status: 200,
    description: "Balance change alerts (newest first)",
  })
  @Get("wallets/alerts")
  getAlerts() {
